      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '480px' }}>
        ...
        <form onSubmit={handleSubmit} className="modal-body" style={{ fontSize: '13px' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px', fontSize: '12.5px', color: '#64748B' }}>
              <span>Total Rent:</span>
              <strong style={{ color: 'var(--color-navy)' }}>PKR {totalAmount.toLocaleString()}</strong>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', fontSize: '12.5px', color: '#0B6947' }}>
          ...
          {mode === 'full' && (
            <div style={{
              ...
              Marking full remaining balance of <strong>PKR {currentBalance.toLocaleString()}</strong> as collected. Payment status will update to <strong>Paid (100%)</strong>.
            </div>
          )}
          ...
          {mode === 'pending' && (
            <div style={{
              ...
              This will reset the payment status to <strong>Pending</strong> with PKR {totalAmount.toLocaleString()} full rent due.
            </div>
          )}
